...
namespace Widgets
{
    class FlightTimeBar : Terraria.UI.UIElement
    {
        protected override void DrawSelf(Microsoft.Xna.Framework.Graphics.SpriteBatch sb)
        {
            ...
            sb.Draw(GetTexture("Widgets/FlightTimeBar"), new Rectangle((int)pp.X + 28 + ci.ftx, (int)pp.Y + 14 + ci.fty, (int)lp.wingTime * 75 / ((0 < lp.rocketBoots ? 42 : 0) + lp.wingTimeMax), 4), Color.White);
        }
    }
}